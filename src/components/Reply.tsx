...
function Reply({ displayName }: { displayName: string }) {
  ...
  return (
    <main onClick={() => updateMessageInputValue(`${messageInputValue} @${displayName}`)} className="cursor-pointer" data-tooltip-content="Mention this user" data-tooltip-id="reply" data-tooltip-delay-show={1500}>
